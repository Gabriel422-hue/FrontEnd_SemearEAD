...
{name: 'Leslie Alexander',
  ...
  export default function About() {
    return (
        ...
        <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3 sm:py-8">
        <p className="mt-6 text-lg leading-8 text-gray-600">
        
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:py-5" >Sobre</h2>
              Sobre o Curso...
            </p>
        </div>
